            ...
            <el-aside :width="tabWidth + 'px'">
                <div>
                    <div class="isClossTab" @click="isClossTabFun">
                        <i :class="isCollapse ? 'el-icon-caret-right' : 'el-icon-caret-left'"><span
                                v-if="!isCollapse">会议室管理系统</span></i>
                    </div>
                    <el-menu :class="'menu'" :default-active="activeIndex" class="el-menu-vertical-demo"
                        @open="handleOpen" @close="handleClose" :collapse="isCollapse" background-color="#545c64"
