        ...
        <el-dialog title="申请会议室" :visible.sync="dialogFormApply">
            <el-form :model="record.conferenceRecord" label-position="right" label-width="80px" status-icon
                ...
                <el-form-item label="开始时间" prop="startTime" style="width: 250px">
                    <el-date-picker v-model="record.conferenceRecord.startTime" type="datetime" placeholder="选择开始日期时间"
                        :picker-options="pickerOptions" @blur="searchTimeConflict" default-time="10:00:00"
                        value-format="yyyy-MM-dd HH:mm:ss">
                    </el-date-picker>
                </el-form-item>

                <el-form-item label="结束时间" prop="endTime" style="width: 250px">
                    <el-date-picker v-model="record.conferenceRecord.endTime" type="datetime" placeholder="选择结束日期时间"
                        :picker-options="pickerOptions" @blur="searchTimeConflict" default-time="10:30:00"
                        value-format="yyyy-MM-dd HH:mm:ss">
                    </el-date-picker>
                </el-form-item>
