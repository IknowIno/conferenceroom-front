    ...
    <div id="body">
        <el-row style="margin-top: 200px">
            ...
            <el-col :span="7" :offset="5" class="mborder">
                <h3 style="text-align: center;position: relative;margin-top: 10px"><i
                        class="iconfont iconhuiyishi" />会议室管理系统</h3>
                ...
                <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="demo-ruleForm"
                    ...
                    <el-form-item prop="password">
                        <el-input prefix-icon="iconfont iconmima " type="password"
            ...
            <el-col :span="4" :offset="1" class="mborder mwarn">
                <el-card class="box-card">
                    <div slot="header" class="clearfix">
                        <el-alert title="登录提示" type="warning" :closable="false">
                        </el-alert>
                    </div>
                    <el-alert title="账号为部门编号，初始密码为123456，可登录后自行修改" type="info" show-icon :closable="false">
                    </el-alert>
                    <el-alert title="联系管理员：2913934618/1984196795@qq.com" type="info" show-icon :closable="false">
                    </el-alert>
                </el-card>
            </el-col>
        </el-row>
...
#body {
    ...
    width: 100%;
    height: 100%;
    background-image: url('../assets/images/meetingroom01.jpg');
